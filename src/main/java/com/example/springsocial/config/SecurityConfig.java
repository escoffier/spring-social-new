...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    RestTemplate restTemplate; //now working
    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        responseClient.setRestOperations(restTemplateBuilder.build());
        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .anyRequest()
                        .authenticated()
                    .and()
                //.authenticationProvider(new OAuth2AuthorizationCodeAuthenticationProvider(responseClient))
                .oauth2Login()
                    .tokenEndpoint()
